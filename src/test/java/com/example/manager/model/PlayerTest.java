...
public class PlayerTest {
	...
	private long computeExpectedMarketValue(Player p, long nowMs) {
		...
		long remainingMs = p.getContractLength() - nowMs;
	...
	public void testAgeAnchorsProduceExpectedMultipliers() {
		...
		p18.setAge(18);
		p18.setContractLength(contractEnd);

		Player p24 = new Player("P24", 60, 60, 0);
		p24.setAge(24);
		p24.setContractLength(contractEnd);

		Player p28 = new Player("P28", 60, 60, 0);
		p28.setAge(28);
		p28.setContractLength(contractEnd);

		Player p32 = new Player("P32", 60, 60, 0);
		p32.setAge(32);
		p32.setContractLength(contractEnd);
